...
- **프리미엄 소재:** 고급 Mazzucchelli, JIMEI, JINYU 아세테이트를 사용하여 가벼우면서도 매우 튼튼한 구조와 생생하고 오래 지속되는 다채로운 색감의 깊이를 제공합니다.
...
풍부한 색채감과 견고한 구조적 내구성을 우선시하는 아이웨어 브랜드를 위해 설계된 이 레트로 스타일의 안경테는 최고급 Mazzucchelli, JIMEI, JINYU 아세테이트를 정밀 가공하여 제작되었습니다.
