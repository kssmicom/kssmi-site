...
materials:
  ...
  - name: 'カーボンファイバーアイウェア'
    subtitle: 'ハイテクレーシング素材'
    points:
      - '高い強度重量比'
      - 'ハイテクな織り目模様の美学'
      - 'オタクとモータースポーツへのプレミアムなフォーカス'
