...
eyebrow: 'フレーム構造'
heading: 'カスタム眼鏡フレーム構造'
subheading: 'フルリムやハーフリムから、リムレス、折りたたみ、クリップオン、フリップアップまで、さまざまな製品目標に合わせたフレーム構造をサポートしています。'
materials:
  - name: 'フルリム'
    subtitle: 'レンズ全体を囲み、最大限のサポートと保護を提供するフレーム構造。'
    points:
      - '360°の安全なレンズ固定'
      - '厚いレンズの端を隠すのに効果的'
      - 'ほとんどのフレーム素材に対応'
  ...
  - name: 'リムレス'
    subtitle: 'レンズをフレームパーツに直接取り付けるミニマルな構造。'
    points:
      - '超軽量で視覚的にもミニマル'
      - '高強度のレンズと正確な穴あけ加工が必要'
      - '目立ちにくい洗練されたデザインに最適'
  ...
  - name: 'クリップオン'
    subtitle: '光学フレームにサングラスクリップを取り付け可能な多機能構造。'
    points:
      - 'メガネからサングラスへの素早い切り替え'
      - 'マグネット式または噛み合わせ式のクリップ装着'
      - '一本で二役をこなす実用的なアイウェア'
  ...
  - name: '折りたたみ'
    subtitle: '収納や旅行に便利な、折りたためるコンパクトな構造。'
    points:
      - 'マルチヒンジ折りたたみ設計'
      - 'ポケットに収まるコンパクトな収納サイズ'
      - '精密な開閉制御が必要'
  ...
  - name: 'フリップアップ'
    subtitle: '前部のレンズを跳ね上げることができる二層構造。'
    points:
      - '屋内・屋外の環境に素早く対応'
      - '上部配置のヒンジメカニズム'
      - 'レトロな雰囲気を持つ機能的なスタイル'
