...
eyebrow: 'フレーム構造'
heading: '眼鏡フレーム構造ソリューション'
subheading: '量産管理の本質：組み立ての盲点や販売後の返品リスクを未然に防ぎ、陸揚げコストを正確に計算し、製品ラインと販売チャネルの間で高収益なマッチングを実現するのに役立ちます。'
materials:
  - name: 'フルリム眼鏡'
    subtitle: '最大限のレンズ保護'
    points:
  ...
  - name: 'クリップオン眼鏡'
    subtitle: '多機能な光学ソリューション'
    points:
      - 'シームレスな磁気アタッチメント'
      - '瞬時に光学からサングラスへ'
      - '正確に位置合わせされたフロントプロファイル'
