...
eyebrow: 'フレーム形状'
heading: 'メガネフレーム形状ソリューション'
subheading: "ブランドがグローバルなフィット感に最適化された市場投入可能なコレクションを構築できるよう、実績のある豊富なシルエット ライブラリと、独自形状のカスタム金型開発能力を組み合わせて提供します。"
materials:
  - name: 'ラウンドメガネ'
    subtitle: '柔らかくバランスの取れた印象を与えるクラシックな円形フレーム。'
    points:
      - '対称的で流行に左右されない'
      - 'メタルやアセテートに最適'
      - 'レトロなデザインによく見られる'
  ...
  - name: 'ヘキサゴンメガネ'
    subtitle: 'モダンなエッジが効いた六角形の幾何学的フレーム形状。'
    points:
      - '個性的で現代的な外観'
      - '視覚的な個性を持つ力強いライン'
      - 'アセテートやメタルに最適'
  ...
  - name: 'オクタゴンメガネ'
    subtitle: '洗練されたモダンな印象を与える八角形の幾何学的フレーム形状。'
    points:
      - '六角形フレームよりもディテールに富む'
      - '目を引くがかけやすい'
      - '精密な成形と仕上げが必要'
  ...
  - name: 'バタフライメガネ'
    subtitle: 'ブリッジから外側に向かって広がる特大のフレーム形状。'
    points:
      - 'ドラマチックでグラマラスなスタイル'
      - '顔をしっかりとカバーする'
      - 'レディースサングラスによく見られる'
  ...
  - name: 'ブローラインメガネ'
    subtitle: '上部のリムが強調された混合素材のフレーム形状。'
    points:
      - '独特でヴィンテージ風'
      - '異なる素材を組み合わせている'
      - 'オプティカルコレクションによく使われる'
