export default {
    ...
    product: {
      ...
      projectFormTitle: "아이웨어 프로젝트에 대해 알려주세요",
      projectFormDesc: "사양이 아직 확정되지 않았더라도 현재 알고 계신 내용을 공유해 주세요. 세부 정보를 검토한 후 맞춤 제작, 샘플링 또는 가격 산정을 위한 가장 적합한 다음 단계를 안내해 드립니다.",
      nameOrg: "이름 / 회사 또는 브랜드",
      officialEmail: "비즈니스 이메일",
      projectDetails: "프로젝트 세부 정보",
      submitRequest: "프로젝트 검토 받기",
      secure256: "안전한 제출 · 구매 의무 없음",
      ndasAvailable: "NDA 체결 가능 · 24시간 이내 1차 답변",
