export default {
    ...
    product: {
      ...
      projectFormTitle: "アイウェアプロジェクトについてお聞かせください",
      projectFormDesc: "仕様がまだ確定していなくても、現時点で分かっている内容をお知らせください。詳細を確認し、カスタマイズ、サンプル製作、価格算出に向けた最適な次のステップをご提案します。",
      nameOrg: "お名前 / 会社名・ブランド名",
      officialEmail: "ビジネス用メールアドレス",
      projectDetails: "プロジェクトの詳細",
      submitRequest: "プロジェクト評価を依頼する",
      secure256: "安全な送信 · 購入義務なし",
      ndasAvailable: "NDA対応可能 · 24時間以内に初回返信",
