...
if ($isAuthenticated && $tab === 'short-links') {
    ...
    try {
        ...
        else { $shortLinkRows = short_link_list($shortLinkSearch); $shortLinkTotal = count($shortLinkRows); }
    }
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .short-links-search input[name="sl_search"] { width: 360px; }
